...
def main(mode, args):
    ...
    #model = SiT_models[args.model](
    #    input_size=latent_size,
    #    num_classes=args.num_claGsses,
    #    learn_sigma=learn_sigma,
    #).to(device)
    # Auto-download a pre-trained model or load a custom SiT checkpoint from train.py:
    #ckpt_path = args.ckpt or f"SiT-XL-2-{args.image_size}x{args.image_size}.pt"
    ckpt_path = f'results/SiT-XL-2-Linear-velocity-None-{args.min_sigma}/checkpoints/{args.load_epoch:05d}.pt' 
    args.sample_dir = f'results/SiT-XL-2-Linear-velocity-None-{args.min_sigma}/samples/{args.load_epoch:05d}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--min-sigma", type=float, default=0.8)
